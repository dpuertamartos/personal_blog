    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1 }}>
        <Routes>
          ...
          <Route path="/" element={<Home theme={theme} drawerOpen={drawerOpen} setDrawerOpen={setDrawerOpen} handleDrawerToggle={handleDrawerToggle} setErrorMessage={setErrorMessage}/>} />
        </Routes>
      </Box>
